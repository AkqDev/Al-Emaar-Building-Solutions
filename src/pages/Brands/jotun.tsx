...
import JotunProducts from '../../data/Jotun';

const Jotun: React.FC = () => {
  const handleWhatsAppClick = (productName: string) => {
    const message = `I want to buy the ${productName} from Jotun products`;
    ...
    <div className="bg-[#fcfcfc] min-h-screen py-16 px-6 font-[Poppins]">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-gray-500 text-base max-w-2xl mx-auto leading-relaxed">
          Explore premium Jotun paints and coatings trusted worldwide for quality and durability. 
          From interior emulsions to exterior primers, find professional solutions for every surface.
        </p>
      </div>

      {/* Grid */}
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-12">
        {JotunProducts.map((product) => (
