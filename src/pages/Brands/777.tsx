...
import SevenSevenSevenProducts from '../../data/777';

const SevenSevenSeven: React.FC = () => {
  const handleWhatsAppClick = (productName: string) => {
    const message = `I want to buy the ${productName} from 777 products`;
    ...
    <div className="bg-[#fcfcfc] min-h-screen py-16 px-6 font-[Poppins]">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-gray-500 text-base max-w-2xl mx-auto leading-relaxed">
          Premium 777 paint products for interior and exterior applications. 
          Choose from oil-based and plastic paints in various finishes for professional and residential projects.
        </p>
      </div>

      {/* Grid */}
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-12">
        {SevenSevenSevenProducts.map((product) => (
