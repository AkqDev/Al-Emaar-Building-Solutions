...
const Hempel: React.FC = () => {
  const handleWhatsAppClick = (productName: string) => {
    const message = `I want to buy the ${productName} from Hempel products`;
    ...
    <div className="bg-[#fcfcfc] min-h-screen py-16 px-6 font-[Poppins]">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-gray-500 text-base max-w-2xl mx-auto leading-relaxed">
          Discover premium Hempel coating solutions and construction materials engineered for durability. 
          From road marking paints to wall putty, find professional-grade products for every project.
        </p>
      </div>

      {/* Grid */}
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-12">
        {HempelProducts.map((product) => (
