          ...
          >
            ...
            <div className="text-gray-600 leading-relaxed text-base md:text-lg max-w-3xl mx-auto lg:mx-0">
              ...
              <div className="flex flex-row gap-6 mt-4 justify-center lg:justify-start mb-10 md:mb-0">
                ...
                <Link to="/khayaat-products">
                  <img src={khayaatLogo} alt="Khayaat" className="h-23 w-57 p-2 object-contain rounded-xl border border-gray-100 shadow-md hover:scale-105 transition-transform bg-gray-300" />
                </Link>
              </div>
            </div>
          </motion.div>
...
export default IntroGypsumItems;
