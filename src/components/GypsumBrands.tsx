...
const GypsumBrands: React.FC = () => {
  const logos: BrandLogo[] = [
    { image: aladwaa, name: 'Aladwaa', route: '/aladwaa-products' },
    { image: asg, name: 'ASG', route: '/asg-products' },
    { image: cobra, name: 'Cobra', route: '/cobra-products' },
  ...
  return (
    <section className="py-12 md:py-20 overflow-hidden bg-gray-900">
      ...
      <div className="!pb-6 md:!pb-12 px-4">
        ...
        >
          Gypsum, Insulation 
          <span className="text-yellow-400 !ml-2 block sm:inline">& Specialized Items</span>
        </motion.h2>
      </div>
